...
//	        String port = "25";
	        ...
	        String mailTo = "ropealse@gmail.com";
	        String subject = "Recibo de Boletazo";
	        ...
	        String textContent = "Esto es texto normal.";
	        ...
	        String message = "<br><i>Hola, buen día, esto es html</i><br>";
	        message += "<b>Sr.</b><br>";
	        message += "<font color=red>Hasta acá es html</font>";
	        ...
	        String dest = "/mnt/compartido/Documentos/Semestre 7/Programación distribuida/mail/fichero.pdf";
	        ...
	        documento.add(new Paragraph("Zona baja: 	$5000"));
